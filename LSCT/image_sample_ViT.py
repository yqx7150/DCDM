...
from LSCT.script_util_ViTs import (
    model_defaults,
    create_model,
    args_to_dict,
...
def main():
    ...
    logger.configure(dir="/home/lqg/Desktop/HR/LDPET/ViTClassifier_sample")
    ...
    for step, batchNcond in tqdm(enumerate(data), desc="LSCClassifier testing..."):
        ...
        sp = "/home/lqg/HR/codes/LDPET/classifiers_feature_logger/vitlabel.txt"
        if  sp is not None:
            # 将特征向量以文本形式保存到文件
            with open(sp, 'a') as f:
